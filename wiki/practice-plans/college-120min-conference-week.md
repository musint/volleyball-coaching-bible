...
drills: [dynamic-warmup-volleyball, jump-warmup, weave-passing, out-of-system-setting, hitting-vs-block, read-blocking-progression, pressure-serving, six-player-defense, wash-drill, king-of-the-court]
sources: [aoc-2017-rose-pennstate-prep, aoc-2013-mccutcheon-eisler-cauldron, aoc-2024-kiraly-stats-matter-most, aoc-2024-kiraly-in-game-tactics, aoc-2024-kiraly-training-efficiently, aoc-2026-bunch-read-blocking, mccutcheon-2022-championship-behaviors]
---

# College 120-minute Conference-Week Practice
...
- Pass 60%+ in-system against the opponent's primary server profile (float-short, jump-topspin, or jump-float depending on scout).
- Side-out 65%+ across rotation 1 and the rotation directly following the opponent's strongest server.
- Out-of-system setters: place 80% of second-ball touches to pin-attackable windows when passed outside the 3 m zone.
- Blocker pairs: execute at least 3 seam-closure touches per 10-ball block-touch segment, matching the scout's primary quick-middle + pin-combo.
- Competitive-cauldron ranking closed with no athlete below a 1.8 average on the day's grade sheet.
...
- **Team size knob:** with a roster below 12, combine the parallel strategic blocks into a single 25-minute [[read-blocking-progression]] + [[hitting-vs-block]] rotation so everyone touches both sides without idle lines.
- **Intensity knob:** if the weekend is back-to-back and legs are the limiter, replace [[jump-warmup]] with extended [[dynamic-warmup-volleyball]] and cap [[pressure-serving]] at 10 minutes to preserve shoulder volume.
- **Duration knob:** compress to 90 minutes by cutting [[weave-passing]] and shortening [[wash-drill]] to 10 minutes; a taper version lives in the 90-min conference-week variant.
