...
# 14U 120-Minute Pre-Tournament Practice

## Context

The Thursday-or-Friday session before a weekend club tournament for a nationally-competitive 14U team. Core offense, serve-receive, and defense are installed; you are sharpening tactical execution, rehearsing scout-driven plays, and loading match-like pressure. See [[age-lens-14u]] for the 14U club-season arc and [[season-planning]] for pre-tournament peaking framing. Heavy emphasis on competition blocks with scoreboards, consequences, and end-game scenarios.

## Learning objectives

- Serve at 45% or better on-zone under heckler pressure, with every server owning a personal reset cue before the toss.
- Execute the team's primary defensive rotation against scouted attack zones with vocalized line/angle responsibilities before each attack.
- Close three compressed end-game scenarios (starting at 18-18 or 20-20) in [[gold-medal-scrimmage]] with a clean validation point.
- Win two consecutive rallies in [[wash-drill]] at least three times per team, without resetting energy between possessions.
- Complete cool-down with every athlete naming one tactical focus for Saturday Game 1.
...
- **Down (12U or true-beginner 14U):** drop [[pressure-serving]] hecklers, run [[queen-of-the-court]] with coach-toss entries, replace [[gold-medal-scrimmage]] with cooperative scoring.
- **Up (HS pre-tournament):** standard [[pressure-serving]] with simulated score, [[gold-medal-scrimmage]] at 22-22 Kiraly validation format [aoc-2024-kiraly-validation-6v6], serve-discipline constraint. Swap the final scrimmage game for [[wash-drill]] 6v6 to 10 banked points against transition-heavy opponents.
