...
related-drills: [swing-block-shuffle]
related-techniques: [blocking-footwork, blocking-hand-position, blocking-read]
sources:
...
1. **Static block literacy first.** Before teaching a swing block, the
...
6. **Close the hands for the block shape.** The swing ends in the same
   ...
   the finish is still a block.

**Directional patterns.**

7. **Pin blocker swinging to the middle.** Less common but taught for
   bunch-read schemes where the pin starts pinched in and needs help
   reading seam sets before releasing back out to the pin.
8. **Middle blocker swinging to the pin.** The most-used pattern. The
   middle drives off the inside foot, arms swing, outside foot plants
   last to square hips to the net. This is the pattern that most replaces
   a middle's 3-step crossover at the college level.
9. **Outside blocker swinging to the middle on a bunch close.** Rare at
   the HS level, common at college in pin-bunch schemes.

**Timing.**

10. **Match the arm swing to the set.** The whole advantage is extra jump
...
11. **Drill against live timing.** Swing blocking can only be tested against
    ...
    basic mechanics are in place.

## Common errors
- **Arm swing too late.** Blocker is still rising into the jump when the
  ball arrives, so peak reach is below hitter-contact height. This is the
  cardinal swing-block failure. Fix: slow the drill back down; the arms
  finish their load at the planting step, not in the air.
- **Arm swing too small.** Little pumps instead of a full sprint swing.
  Adds no jump, costs time. Fix: exaggerate the swing in drill work,
  then reconverge toward game-speed shape.
- **Body not squared on landing.** Blocker jumps off a sideways plant
  and lands twisted. Fix: the outside foot plants last on a middle-to-pin
  swing so hips rotate back square before leaving the ground.
- **Overshooting the sideline.** Blocker carries lateral momentum through
  the jump and lands outside the antenna. Fix: the plant is a stop, not
...
Swing blocking is a generational technique. Before roughly 2005 it was
a niche national-team and professional tool; through the 2010s and 2020s
it became the default at the D-I college level and the modern HS standard
is to teach it by sophomore year. Not everyone agrees with the full
adoption.

**The modern-mandatory position.** Luka Slabe (AOC) is representative:
...
- **HS JV / first-year varsity:** teach static as the foundation; introduce
  ...
  it in match play. This matches AOC's typical progression.
- **HS varsity mature / club 16U+:** swing blocking as default for outside
  blockers; middle uses whichever pattern gets them on time more reliably.
- **College / professional:** swing block as system-wide default; dissent
  here is rare enough to be a program-distinguishing choice rather than
  a norm.

The through-line across schools: swing blocking is the modern standard at
competitive adult-adjacent levels, with real dissent about whether the
juice is worth the squeeze relative to other practice priorities. Coaches
should adopt it when the reading and static-block foundations are in
place, not before.
