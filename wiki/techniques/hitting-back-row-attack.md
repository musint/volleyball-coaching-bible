...
type: technique
skill: hitting
subskill: back-row-attack
positions: [outside-hitter, opposite, libero]
related-drills: []
related-techniques: [hitting-approach, hitting-arm-swing, hitting-shot-selection, setting-tempo]
sources:
...
attacker game into a four- or five-attacker game, particularly in men's
volleyball and top women's programs.

The most common back-row attacks are the **pipe** (a high-tempo set to
position 6, straight up the middle of the court), the **bic** (a quick-
tempo set behind the middle blocker, synchronized with the middle's
quick to collapse the block), the **D** (a high set to position 1, right
back), and the **A** (a high set to position 5, left back). Pipes and
bics are the go-to back-row attacks for modern women's college and
national-team offenses; D and A are situational, used to release the
opposite (D) or outside (A) into a back-row swing when the front row
is crowded or blocked.
...
3-meter line with her foot until after takeoff. The takeoff is slightly
more horizontal than a front-row approach (to carry the hitter forward
...
- **Taking off in front of the 3-meter line.** The foot crosses the
  line before takeoff, producing a foul (back-row attacker may not
  leave the ground from in front of the 3-meter line for a front-row-
  tempo attack). Fix: mark the 3-meter line clearly in practice;
  coach takes off cues from behind the line; film approach and check
  the takeoff point. Common in young and transitioning hitters.
...
- **Not committing to the jump.** The back-row hitter hesitates on
  the takeoff because the set looks low or off. Result: a weak
  one-leg takeoff, a broad-jump through the ball, or the hitter
  pulls off entirely and the set lands in. Fix: commit on setter
  release; the default is "swing, even ugly"; pulling off should be
  coach-coached, not hitter-improvised.
...
- **Back-row hitter hitting down too aggressively.** The back-row
  contact point is farther from the net than a front-row contact,
  so an exaggerated down-angle swing buries the ball in the net.
  Fix: cue "hit through the ball, drive it deep"; deep-corner
  targets force a flatter swing angle. Most back-row kills land in
  zones 1, 5, or the deep seam, not zones 2/3/4 close to the net.

- **Taking predictable shots.** Back-row attacks are often flat-drive
  shots down the middle. A defense that knows this shifts deep and
  reads the approach. Fix: mix in back-row tips (rarely), deep-
...
- **Running pipe and bic without a middle commit.** Both are effective
  ...
  calls; 14U setters often need explicit reminders to call both.
