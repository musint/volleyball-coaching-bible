...
- **Research hypothesis:** AOC clinic recordings featuring Speraw; UCLA practice footage; AVCA technical-session transcripts; interviews with Speraw's assistants or players.
- **Added:** 2026-04-23

### wiki/coaches/john-speraw.md
- **Claim:** Which specific NCAA-championship program Speraw served as assistant coach at.
- **Why unsourced:** USAV profile asserts the player/assistant/head-coach treble but doesn't name the program/year for the assistant role.
- **Research hypothesis:** Volleyball Hall of Fame records; UCLA or UC Irvine program histories; career-summary articles (not merely USAV profile).
- **Added:** 2026-04-23
...
- **Why unsourced:** The AOC corpus reviewed here identifies her affiliation as Penn State through 2018 and as Notre Dame from at least 2023 onward, but does not specify hire date, title, or the path between. The Task 1.11 brief also references Texas/Louisville assistant stops and a Loyola Marymount head-coaching stop; none are substantiated in the reviewed AOC content.
- **Research hypothesis:** Notre Dame athletics staff-directory history; AVCA coach-placement archives; Penn State media-guide archive for departure date; Loyola Marymount / Texas / Louisville volleyball staff archives for the intermediate stints; Rockwell's own public bio on the Notre Dame website.
- **Added:** 2026-04-24

### wiki/coaches/salima-rockwell.md
- **Claim:** Specific prescriptions inside Rockwell's 2018 AOC paywalled lecture "Creating a competitive culture for female athletes" (beyond the thematic framing that competitive disposition is a trainable construct).
...
## [2026-07-27] physical.md: girls PHV numeric window (backfill hypothesis)
- Page: wiki/physical.md, Rebuild band. Current text is deliberately qualitative: "Growth velocity peaks somewhere inside this band for most girls, and the between-athlete spread is wide enough that you manage the individual rather than the birth year."
- Why unsourced: no source page in wiki/sources/ carries a numeric PHV window for girls (grep of PHV / peak height velocity / maturation / growth spurt found no year-precise figure).
- Where to look: Malina, Bouchard and Bar-Or, Growth, Maturation, and Physical Activity (2nd ed., Human Kinetics 2004), somatic growth chapter; Mirwald et al. 2002 maturity-offset paper (Med Sci Sports Exerc). Ingesting either restores the year-precise window (commonly cited near 11.8 to 12.5 years).
