...
type: source
source-type: article
title: "Middles: Learning to attack behind the setter"
author: "Ryan Hofer"
year: 2019
citation-key: aoc-2019-middles-attack-behind-setter
raw-file: raw/articles/aoc-2019-middles-attack-behind-setter.md
url: https://www.theartofcoachingvolleyball.com/middles-learning-to-attack-behind-the-setter/
topics: [middle-attack, slide, transition, quick-set, blocking, middle-blocker, drills]
...
- Drill mechanics:
  - Setup: 6 offensive players on one side, 6 defensive players on the other.
...
- Slide attack mechanics (behind the setter)
- Transition conditioning for middles
- Integrated team drill (coach-initiated free ball + outside swing)
