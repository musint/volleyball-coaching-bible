...
raw-file: raw/books/notes-hebert-beyond-xs-and-os.md
url: https://en.wikipedia.org/wiki/Mike_Hebert
topics: [coaching-philosophy, program-management, gym-culture, trust, reading-defense, learned-optimism, statistics-skepticism, autobiography]
featured-coaches: [mike-hebert]
...
The Task B.9 cluster brief named this source "Mike Hebert, *Beyond X's and O's*"
...
book explicitly with the second understood across multiple catalogs to be *Thinking
Volleyball*. Hebert's earlier 1991 *Insights and Strategies for Winning Volleyball*
(Leisure Press, ISBN 0880114231) is a third book that Wikipedia did not include in
its "two books" count.

**Conclusion:** "Beyond X's and O's" is a marketing tagline for *Thinking Volleyball*,
not a separate book. The slug `notes-hebert-beyond-xs-and-os` is retained for cluster
continuity. This source page consolidates Hebert's full coaching-writings catalog
(*Insights and Strategies* 1991, *The Fire Still Burns* 1993, *Thinking Volleyball*
2013) under the "beyond X's and O's" thematic frame the publisher actually used,
...
reduce to is, by itself, insufficient for program-level results. Of *Thinking
Volleyball*'s ten chapters, only two are tactical (offense, defense); the remaining
eight cover program management, organizational structure, team playing style,
gym culture, trust, match coaching, team policy, goals, event management,
injured-player management, and communication systems. The book's shape is itself
the argument.
...
(All claims here are documented across the existing wiki source page
...
- **Program management is a first-class coaching skill.** Eight of ten *Thinking
  Volleyball* chapters are program/culture/management; only two are tactical.
  Hebert's structural-decisions-determine-outcomes argument frames coaching
  effectiveness as substantially decided outside the practice gym.

- **Reading defense over rigid base defense.** Hebert's signature tactical
  contribution. Players read set and hitter tendencies and posture themselves
  accordingly, rather than playing fixed rotational base positions. The framing
  anticipates the read-oriented defense language later visible in [[gold-medal-squared]]
  and Art of Coaching materials.

- **Gym culture and trust rival systems in program outcomes.** A well-designed
  system executed by a fractured group produces worse outcomes than an ordinary
  system executed by a cohesive group. Culture work is a primary driver of the
  scoreboard, not a soft complement to tactics.

- **Statistics skepticism from a former evangelist.** Hebert began as a stats
  advocate, later questioned whether time cost of detailed stat collection
  actually paid back in program outcomes. The portable lesson is to measure the
  thing that will change a decision, not the thing easy to count.

- **Learned optimism as a coaching variable.** Hebert treats it as something a
  coach builds into the program rather than as an athlete personality trait.
...
- **Editorial blurbs locating the work.** Russ Rose: "*Thinking Volleyball* is a
  must-read. Coaches will benefit from Mike Hebert's years of experience and
  success in building programs at every level." Kelly Sheffield: "Others that
  have written analysis have not come as close to the essence of coaching
...
### *The Fire Still Burns* (1993, autobiography with Dave Johnson)
- Hebert's life narrative through the early-1990s mid-Illinois-tenure period
- Korean-War-era family background, Peace Corps service, anti-war activism,
  bi-racial-marriage challenges
...
- Marketing positioned by publisher as "beyond the Xs and Os"
...
- **Raw file:** `raw/books/notes-hebert-beyond-xs-and-os.md`
- **Primary URLs:**
  - Wikipedia bio: https://en.wikipedia.org/wiki/Mike_Hebert
  - *Thinking Volleyball* publisher: https://us.humankinetics.com/products/thinking-volleyball-pdf
...
- **Disambiguation note:** This source page documents the *Beyond X's and O's* /
  *Thinking Volleyball* naming discrepancy specifically so future agents do not
  re-attempt to source a non-existent volume. The canonical *Thinking Volleyball*
  source page remains [[hebert-2013-thinking-volleyball]]; this composite is its
  bibliographic-context companion.
