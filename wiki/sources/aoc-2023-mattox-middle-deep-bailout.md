...
type: source
source-type: article
title: "Middle hitters only drill: Deep court with a bailout"
author: "Tod Mattox"
year: 2023
citation-key: aoc-2023-mattox-middle-deep-bailout
raw-file: raw/articles/aoc-2023-mattox-middle-deep-bailout.md
url: https://www.theartofcoachingvolleyball.com/middle-hitter-drill-deep-court-with-a-bailout/
topics: [middle-attack, push-set, flare, back-set, out-of-system, bailout, approach-timing, offense]
...
## Topics covered
- Middle push / flare set
- Back set as OOS bailout
- Approach-timing cue for middles
- Set-off-net distance as coaching metric
- Small-sided middle-only drill design
