...
type: source
source-type: article
title: "Motor pattern exercises to improve your hitting form"
author: "Alessandro Licata"
year: 2025
citation-key: aoc-2025-licata-motor-patterns-hitting
raw-file: raw/articles/aoc-2025-licata-motor-patterns-hitting.md
url: https://www.theartofcoachingvolleyball.com/motor-pattern-exercises-to-improve-your-hitting-form/
topics: [hitting, arm-swing, motor-learning, italian-school, youth, spike-mechanics]
featured-coaches: [alessandro-licata]
schools: [art-of-coaching-volleyball, italian-volleyball]
trust-tier: 2
---

# Motor pattern exercises to improve your hitting form
...
- Amplitude and bilateral symmetry in spiking
- Progression: arms-only → clock → kneeling → throw → grounded hit → elevated platform → trampoline
- Italian school approach to hitting mechanics
