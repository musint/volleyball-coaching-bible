...
url: https://www.hmmrmedia.com/2023/10/gaincast-episode-275-championship-behaviors-with-hugh-mccutcheon/
topics: [coaching-philosophy, motor-learning, skill-acquisition, practice-design, deliberate-practice, leadership, fivb]
...
Composite source page covering McCutcheon's post-*Championship Behaviors*
output: recurring podcast appearances, the November 2024 FIVB Secretary
General appointment, the TEDx Fargo "Championship Behaviors" talk, and the
2022 transition from Minnesota head coach to Assistant Athletics Director /
Sport Development Coach. McCutcheon has not published a second book; this
note grounds wiki citations on the post-book corpus where citing the book
...
- **Fundamental mastery at the elite level.** "Everybody at the highest
  levels has the physical tools to be great. So it comes down to fundamental
  mastery." (GAINcast 275, ≈14:00)
- **Against controlled-input practice.** "Coaches tend to want to operate
  with controlled inputs leading to controlled outputs… But it's not the
  game." (GAINcast 275, ≈17:15)
- **Practice ≠ exercise.** "Practicing without intention is working out and
  you can do that on a treadmill down at the gym." (GAINcast 275, ≈17:15)
