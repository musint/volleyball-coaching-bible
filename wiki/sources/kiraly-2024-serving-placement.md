...
type: source
source-type: article
title: "Karch Kiraly: Serving placement strategies"
author: "Karch Kiraly"
year: 2024
citation-key: kiraly-2024-serving-placement
...
topics: [serving, serve-strategy, float-serve, passer-setter-connection, perception]
...
## Key claims / ideas
- Three-part serve strategy:
  1. Target the weakest passer with a hard, flat float serve.
  2. Serve Zone 2 (toward the setter) to disrupt the passer-setter connection and tangle the opponent's offense.
  3. Vary serve depth rather than side-to-side placement.
- Perceptual grounding (Kiraly, quoted): passers read lateral motion faster than depth motion, so depth variation is the higher-leverage disruptor.
- Serving is reframed as a tactical weapon: intelligent placement beats raw power.

## Topics covered
- Serve targeting (individual weaknesses)
- Zone-based serving against the setter
- Depth vs. lateral placement theory
- Perceptual cues available to the passer
- Serve-plan construction at the national-team level
