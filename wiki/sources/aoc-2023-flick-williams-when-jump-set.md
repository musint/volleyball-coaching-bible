...
type: source
source-type: article
title: "When to train setters on jump setting"
author: "Diane Flick-Williams"
year: 2023
citation-key: aoc-2023-flick-williams-when-jump-set
raw-file: raw/articles/aoc-2023-flick-williams-when-jump-set.md
url: https://www.theartofcoachingvolleyball.com/when-to-train-setters-on-jump-setting/
topics: [setter, jump-set, setting-progression, age-appropriate-progression]
...
## Topics covered
- Jump-set progression and prerequisites
- Age/skill appropriateness for jump setting
- Drill: jump-then-set
