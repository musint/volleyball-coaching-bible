...
raw-file: raw/books/notes-polish-or-russian-federation-manual.md
topics: [russian-school, polish-school, federation-coaching-literature, philosophy, blocking, program-building, systems-volleyball]
featured-coaches: [vyacheslav-platonov, hubert-wagner, andrzej-niemczyk]
schools: [russian-school, polish-school]
trust-tier: 1
---
...
dominance: Olympic gold (1980 Moscow), World Championship golds (1978 Italy,
1982 Argentina), and **five consecutive European Championship golds 1977-1985**.

Per the cluster-brief instruction ("Pick whichever has more accessible
material"), the composite documents Platonov as the primary anchor with
PZPS-side Polish federation literature documented at composite level with
`[unsourced]` / `[translation-needed]` flags. No widely-distributed
English-translated PZPS coaching manual is surfaced in the 2026-04-24 search;
Hubert Wagner's biographical record describes his methodology but no
Wagner-authored coaching textbook is documented; Andrzej Niemczyk's *Life
tie-break* is a Polish-language memoir, not a federation methodology manual.

The composite is the source-page-of-record for the existing wiki coach
profile at [[vyacheslav-platonov]] and feeds [[russian-school]] and
[[polish-school]] doctrine claims.
...
- **Theory + practice without instructional drills.** Per the coachingvb.com
  ...
  not a drill-book. Coaches expecting drill prescriptions will be disappointed;
  pair with a drills-oriented Eastern-bloc reference.
- **Five-axis structure:** developing your own coaching style; building a
...
- **Blocking-fundamentals chapter.** A single in-depth technical chapter on
  ...
  center of gravity.
- **Coach as program-builder.** The book is structured as advice from one
  head coach to another; the program-building frame, not match-tactician
  frame, dominates.
- **Pre-rally-scoring context.** Some content reflects the pre-2000 game;
  Platonov anticipated certain rule and tactical changes, but readers must
  contextualize against the era.
- **"Multiple readings" recommendation.** Reviewer frames the book as
  rewarding re-engagement; "bite-sized chunks" structure suits busy coaches.
...
- **Hubert Wagner (1941-2002)**: Polish men's NT head coach, **1974 World
  ...
  team court-time reportedly 11+1⁄2 hrs vs. opponents' 5 hrs), aggressive
...
- Soviet / Russian federation coaching methodology
- Block-and-defense as program identity (Russian-school core principle)
- Pre-trained team patterns and "systems volleyball"
- Coach-as-program-builder doctrine
- Polish federation coaching literature (composite-level)
- Hubert Wagner's "Wonder Team" methodology characteristics
- Andrzej Niemczyk's Golden Girls era
...
- Raw file: `raw/books/notes-polish-or-russian-federation-manual.md`
- coachingvb.com book review (primary English summary):
  https://coachingvb.com/book-review-my-profession-the-game/
- marklebedew.com book release post (2014):
  https://marklebedew.com/2014/02/23/platonov-book-on-sale-now/
- marklebedew.com original-context post (2014):
  https://marklebedew.com/2014/02/17/my-profession-the-game/
