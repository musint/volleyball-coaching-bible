...
topics: [japanese-training, federation-coaching-literature, technique, systems, multiple-quick-attack]
featured-coaches: [yasutaka-matsudaira, hirobumi-daimatsu]
...
queued for future Japanese-language ingest.

If a future ingest surfaces a specific Mizoguchi-authored title (Hiromasa
Mizoguchi, Toshio Mizoguchi, Yasuaki Mizoguchi, or another given-name pairing),
this composite should be split into a dedicated single-book source page and the
[translation-needed] flags should be cleared on the affected entries.
...
- **The 1971 course is the institutional anchor** for Japanese federation
  coaching-literature dissemination into the international game; it was
  produced during the period between the 1964 Tokyo women's gold and the
  1972 Munich men's gold, when the Japanese program had the strongest
  institutional case to be exporting methodology.
- **"Mizoguchi" as a category placeholder.** Without a verifiable single-author
...
- **Expected thematic content** of Japanese federation coaching textbooks of
  ...
  culture, and physical-conditioning periodization designed around a
  smaller-stature player base.

## Topics covered

- Japanese federation coaching-literature institutional history
- 1971 IVBF first coach-training course in Tokyo
- The category of Japanese-language volleyball coaching texts
- Cross-reference to Matsudaira-era methodology (multiple quick attack)
- Cross-reference to Daimatsu-era methodology (receive-platform commitment)

## Where it's cited

*(populated as wiki pages cite this composite)*
