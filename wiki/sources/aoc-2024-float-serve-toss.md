...
type: source
source-type: article
title: "Great float serves start with a great toss"
author: "John Dunning"
year: 2024
citation-key: aoc-2024-float-serve-toss
raw-file: raw/articles/aoc-2024-float-serve-toss.md
url: https://www.theartofcoachingvolleyball.com/great-float-serves-start-with-a-great-toss/
topics: [serving, float-serve, serve-toss]
...
## Topics covered
- Toss mechanics and placement (in front)
- Timing of forward step relative to toss
- Low, flat serve trajectory
- Isolated toss practice as a drill
