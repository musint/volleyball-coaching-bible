...
type: source
source-type: article
title: "Back row attacking basics"
author: "Mark Barnard"
year: 2023
citation-key: aoc-2023-back-row-attacking-basics
raw-file: raw/articles/aoc-2023-back-row-attacking-basics.md
url: https://www.theartofcoachingvolleyball.com/back-row-attacking-basics/
topics: [back-row-attack, hitting, setter-hitter-connection, drills, 10-foot-line]
...
- Back-row attacking drill:
  ...
  - Requirements: 2+ players, balls, coach, full court.

## Topics covered
- Back-row attack fundamentals
- Setter leading the hitter (set placement)
- Simple drill to introduce back-row attacking
