...
type: source
source-type: article
title: "A Protocol for the Biomechanical Evaluation of the Types of Setting Motions in Volleyball Based on Kinematics and Muscle Synergies"
author: "Lanzani, V., Brambilla, C., Moscatelli, N., & Scano, A."
year: 2026
citation-key: lanzani-2026-setting-kinematics-protocol
...
# A Protocol for the Biomechanical Evaluation of the Types of Setting Motions in Volleyball
...
- Five distinct upper-limb muscle synergies coordinate the volleyball set across set types.
- Different set destinations (front-row outside vs. middle vs. back-row) recruit different synergy patterns.
- Flexion-extension angles are highly repeatable across sessions (r > 0.90).
- Rotational components (shoulder rotation, forearm pronation-supination) are the fragile element of set-technique.
- Coaching cues and feedback should target rotational consistency, where set-quality variability lives.

## Topics covered

- Setting biomechanics
- Multi-set-type kinematic comparison
- Muscle synergies in volleyball
- Test-retest reliability
- Coaching-evaluation protocols
