...
type: source
source-type: article
title: "Pushing through the ball with your lower body will improve your setting"
author: "Marco Meoni"
year: 2020
citation-key: aoc-2020-meoni-lower-body-setting
raw-file: raw/articles/aoc-2020-meoni-lower-body-setting.md
url: https://www.theartofcoachingvolleyball.com/lower-body-setting/
topics: [setter, setting, setting-footwork, italian-setting, setting-mechanics, jump-set]
featured-coaches: [marco-meoni]
schools: [italian-school, art-of-coaching-volleyball]
trust-tier: 2
---

# Pushing through the ball with your lower body will improve your setting
...
## Topics covered
- Setter footwork and lower-body mechanics
- Setting push chain (feet → hands)
- Right-foot-forward setting stance
- Back-set hip discipline
- Jump-set landing mechanics
- Setter movement patterns (when + how)
- Arm carriage while running to the set
