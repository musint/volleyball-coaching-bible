...
## Key claims / ideas
- When a team has a bad server, Rose recommends they serve from middle-back (not right-back).
- (Video-only page; rationale detailed in video content, not body text.)

## Topics covered
- Serve position selection for weaker servers
- Managing rotations to hide / protect poor servers
