...
type: source
source-type: article
title: "Hitting: Scoring off the block drill"
author: "Mark Barnard"
year: 2023
citation-key: aoc-2023-barnard-scoring-off-block
raw-file: raw/articles/aoc-2023-barnard-scoring-off-block.md
url: https://www.theartofcoachingvolleyball.com/hitting-scoring-off-the-block-drill/
topics: [tooling, wipe, high-hands, hitting-drills, team-offense, outside-hitter, offense]
...
- Rotate parameters: wipe off outside blocker's hands; hit high off the top so ball ricochets up/out.
- Requires 5+ players, balls, coach, full court.

## Topics covered
- Tooling as intentional scoring
- Wipe off outside blocker
- High-hands ricochet
- Offense-vs-block drill design
