...
type: source
source-type: book
title: "Transformando Suor em Ouro (Turning Sweat into Gold)"
author: "Bernardo Rezende (Bernardinho)"
year: 2006
citation-key: bernardinho-2006-transformando-suor-em-ouro
raw-file: raw/books/notes-bernardinho-2006-transformando-suor-em-ouro.md
url: https://www.amazon.com/Transformando-Suor-Ouro-Portugues-Brasil/dp/8575422421
topics: [brazilian-school, coaching-philosophy, leadership, mental-training, pressure, team-culture, work-ethic, practice-design]
...
The book is the **primary methodology source** for the Bernardinho coach
profile and the Brazilian-school page. It substantiates the work-ethic /
preparation-first framing, the psychological-composure teachings, and the
team-culture principles that have been widely associated with Bernardinho
in Brazilian sport media but previously went un-sourced in the wiki
biographical sources.

## Key claims / ideas

- **"Preparation will always be more important than the game itself."** The
  single throughline teaching. Training intensity directly determines
  competition outcomes. No shortcuts; intense work is the shortest path.
- **Talent is insufficient without relentless preparation.** Detecting and
  developing talent is the leader's primary responsibility, not
  discovering it.
- **Roda da Excelência (Wheel of Excellence).** Bernardinho's integrating
  framework: preparation + discipline + team culture + pressure management
  + continuous improvement. The Wheel is explicitly framed as synthesis of
...
- **Emotional strengthening prevents task-execution focus loss.** Deciding-
  set composure is treated as a trainable discipline rooted in
  psychological preparation, not a temperament trait.
- **The "treacherous trap" of success.** Champions are vulnerable when
  achievement breeds arrogance; continuous questioning is the defense.
- **Collectivity supersedes individual brilliance.** Roster composition
  prioritizes fit over peak talent where the two conflict; "right people
  over most-talented people" is a recurring line.
- **Commitment, complicity, discipline.** The three-word team-culture
  shorthand: commitment to the program, complicity with teammates,
  discipline in preparation.
- **Leadership inspires rather than demands.** Belief in a player's
  potential raises productivity; coercion does not.
- **Champions control vanity while elevating teammates' performance.**
...
- Volleyball coaching methodology and the Roda da Excelência framework
- Practice design, training volume, and preparation standards
- Team culture: commitment, complicity, discipline, roster fit
- Psychological composure, pressure management, deciding-set mentality
- Coaching philosophy influences (Greek philosophy, business leadership)
...
- **Trust tier: 1**: Bernardinho's own authored volume. Primary-source
  ...
  scholarly context on the Wheel framework.

## Known limitations

- The wiki's notes are **fair-use synthesis** built from publisher-preview
  material, third-party summaries (PocketBook4You, SlideShare), and
  reader-review aggregation (Goodreads). A full PDF ingest would expand
  the quotable passage inventory. Cite claims at the principle level, not
  at page-number specificity, until a full-book ingest occurs.
- The book is Portuguese-language; English translations of quotes in the
  raw notes are coach-and-reviewer paraphrases, not canonical English
  renderings.
