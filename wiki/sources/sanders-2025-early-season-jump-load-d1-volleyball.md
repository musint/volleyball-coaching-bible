...
- Jump-count and jump-intensity monitoring
- Countermovement-jump (CMJ) for fatigue detection
- Force-velocity-power profiling
- Inertial measurement units (VERT, Hawkin)
- Early-season "shock phase" load management
- Position-specific jump thresholds
