...
topics: [blocking, bunch-read, footwork, defensive-systems, technique]
...
eyework, tactical positioning) and names the specific footwork patterns
taught (jump-in-place, 2-step shuffle, 3-step shuffle Q3, 2-step crossover
X2, 3-step crossover X3). It is a direct source for the GMS vocabulary of
blocking cues and progressions.

## Key claims / ideas
- Bunch-read as the GMS default system (25+ years of use per the guide).
- Spacing: "elbows to elbows" left, "hands to hands" right.
- Arm position: start hands down for mobility; arms together when reaching
  over to avoid split-block surfaces.
- Eyework: setter first, transition to hitter by jump time.
- Cue: "big running second step" on crossover movements.
...
- Footwork patterns and nomenclature.
- Blocker eyework sequence.
- Armwork and seam coverage.
- Training progression from blocked to variable.
