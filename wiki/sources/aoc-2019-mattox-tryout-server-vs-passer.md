...
type: source
source-type: article
title: "Tryout drill: Server vs. passer"
author: "Tod Mattox"
year: 2019
citation-key: aoc-2019-mattox-tryout-server-vs-passer
raw-file: raw/articles/aoc-2019-mattox-tryout-server-vs-passer.md
url: https://www.theartofcoachingvolleyball.com/tryout-drill-server-vs-passer/
topics: [serve-receive, tryouts, evaluation, serving, passing-drills]
featured-coaches: [tod-mattox]
schools: [art-of-coaching-volleyball, bishops-school]
trust-tier: 2
---

# Tryout drill: Server vs. passer
...
- Server-passer 1v1 format
- Target-player adjudication
- Ladder-movement competitive scoring
