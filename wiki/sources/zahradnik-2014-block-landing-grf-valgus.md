...
type: source
source-type: article
title: "Ground Reaction Force and Valgus Knee Loading during Landing after a Block in Female Volleyball Players"
author: "Zahradnik, D., Uchytil, J., Farana, R., & Jandacka, D."
year: 2014
citation-key: zahradnik-2014-block-landing-grf-valgus
...
- Run-back landings produce significantly higher knee-valgus moments than step-back landings on the dominant limb.
- Risk gradient (lowest to highest valgus loading): stick → step-back → run-back.
- Vertical GRF differences across landing types were not statistically significant in this sample, though run-back trended higher.
- Internal rotation variability is highest in run-back landings, an additional ACL risk marker.
- The "block, run-back to defend" sequence is the highest-priority landing-pattern for female-specific injury-prevention training.

## Topics covered

- Female-specific landing biomechanics
- Ground reaction forces
- Knee-valgus loading
- ACL-injury risk in women's volleyball
- Block-recovery strategies
- Landing-pattern risk gradient
