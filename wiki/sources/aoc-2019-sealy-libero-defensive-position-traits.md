...
type: source
source-type: article
title: "Traits of a Good Libero: Defensive Position"
author: "Mike Sealy"
year: 2019
citation-key: aoc-2019-sealy-libero-defensive-position-traits
...
topics: [libero, defense, positional-zone, libero-traits, women-volleyball]
...
- Libero defensive position trait profile: read discipline, platform consistency, line-cut decision-making, lateral coverage range.
- Defensive base selection (LB vs MB) is part of the libero's role definition.
- Trait-based assessment for libero placement (which player on the roster fits the LB-base profile vs MB-base profile).

## Topics covered

- Libero defensive-position trait framework.
- LB vs MB selection criteria.
- Libero development at HS+/college level.
