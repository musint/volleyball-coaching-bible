...
type: source
source-type: article
title: "Proper volleyball setting technique: Comprehensive training for young players"
author: "Emily Kohan"
year: 2023
citation-key: aoc-2023-kohan-setting-fundamentals-young
raw-file: raw/articles/aoc-2023-kohan-setting-fundamentals-young.md
url: https://www.theartofcoachingvolleyball.com/setting-teaching-the-fundamentals-to-a-young-player/
topics: [setter, setting, setting-fundamentals, youth-setting, setting-hands, setting-footwork]
featured-coaches: [emily-kohan]
schools: [art-of-coaching-volleyball]
trust-tier: 2
---

# Proper volleyball setting technique: Comprehensive training for young players
...
- At-home drills: isolate hand contact with setter ball (heavier), footwork "flower" pattern without ball, tape/markers for distance setting goals.
- Progression: hold off on hitters until setter clears first 4 stages; add jump set and reading only after clean contact and muscle memory are established.

## Topics covered
- Setting fundamentals for youth setters
