...
drills:
  ...
  - ball-control-warmup
  - butterfly-passing
  - munciana-three-man-tilt
  - munciana-rush-and-push
...
Grouped by skill, each drill cited inline with a one-line rationale.
...
- **Preseason (first 4 weeks):** lean on the warm-up and passing drills plus target-setting. Defer competitive grading until ball-control is ready. Cooperative-25-Goal sneaks in toward the end of preseason once teams string clean sequences together.
- **Mid-season:** rotate the full bench. Run the Munciana tilt-chain (three-man-tilt → rush-and-push → straight-line-passing) on consecutive days as a one-week ball-control block. Wash-drill enters once cooperative-25-goal is stable.
- **Pre-tournament:** bias toward Queen of the Court and low-intensity wash. Volume drops; competitive intensity stays. No new mechanics inside two weeks of a tournament.
- **Tryout:** target-setting, serve-targets, butterfly-passing, and a short Queen of the Court block give a strong evaluation cross-section.
- **Postseason:** more wash (still 6-point), more Queen of the Court, continue tilt patterns toward 13s.

## Adaptations

The 12s adaptations are the same logic as the 14U age-lens but pulled back one notch on every dimension: distances shorter, cadences slower, scoring targets lower, ball delivery softer (tosses before serves; free-balls before swings). Specifically:
