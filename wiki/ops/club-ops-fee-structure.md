...
- **Court rental.** Practice gym time is the largest single line for most clubs without owned space. Price per court-hour, multiply by team-count, weeks-per-season, and practices-per-week. Add hosted-event court time separately.
...
```
[Club Name] — 2026-27 Season Fee Schedule

Tier: National 14 Black
  Tuition: $X,XXX (covers practice, regional + national tournaments, coach pay, USAV)
  Add-ons (separately billed):
    - Travel (Nationals, qualifiers): $X,XXX (estimate; reconciled post-event)
    - Uniform package (new this season): $XXX
    - USAV athlete membership: $XX (paid direct to USAV)
  Total expected season cost: $X,XXX–$X,XXX
  Payment plan: $XXX deposit at acceptance; balance in 4 monthly installments (Nov–Feb)

Tier: Regional 14 Blue
  Tuition: $X,XXX (covers practice, regional tournaments, coach pay, USAV)
  Add-ons: Uniform $XXX, USAV $XX
  Total expected season cost: $X,XXX
  Payment plan: $XXX deposit; balance in 3 installments

Tier: Development 14 Green
  Tuition: $XXX
  All-inclusive (uniform + USAV included)
  Payment plan: paid in full at acceptance

What's NOT included at any tier: private coaching, individual lessons, optional clinics, family travel/lodging.
What financial aid is available: see [Aid application] — apply by [date].
Refund policy: [tiered by date].
```

### Financial-aid application template

```
[Club Name] — Financial Aid Application 2026-27

Athlete name: ____  Tier offered: ____
Family AGI (most recent tax year): ____
Number of children in household: ____
Other club/sport tuition this household pays: ____
Requested aid level: [ ] 25%  [ ] 50%  [ ] 75%
Volunteer-hour commitment if partial aid: ____ hours

Confidentiality: this form is reviewed only by the club director and treasurer. Coaches are not informed of aid status. Decisions communicated by [date].
