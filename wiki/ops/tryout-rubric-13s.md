...
| **Mental, system, athletic baseline** (FeedForward-receptive; runs 4-2 without whiteboard; 6-2 introduced; landing mechanics neutral; emergent self-talk) | Performative humility; loses rotation; valgus-collapse landings. | Self-corrects after multiple cues; rotation tracking inconsistent; landing mixed. | One-cue self-correct; runs 4-2 without whiteboard; bilateral landings knees-over-toes. | 6-2 reps banked; self-talk vocabulary present; unilateral landings clean; stick-or-step-back default. | Position-identity emerged (setter / OH / libero / MB lane visible); sustained self-talk routine; 14U specialization-onset profile per [[age-lens-14u]]. |

## Scoring

Each criterion scored 1-5. Total possible: 40. Position-conditional bonuses are not added — instead, a 5 on the **position-defining** criterion (setting for setters, hitting for OH/MB, defense for libero candidates) plus ≥3 on every other line is the standard 14U-entry profile. The standing-topspin gate (criterion 6) must score ≥3 for a 13s graduate; sub-3 athletes remain 13s-track regardless of total score.

## Calibration notes

**Session length.** A 60-90-minute tryout is the design envelope. Allocate roughly: 10 min dynamic warm-up + landing-mechanics observation; 15 min ball-control / passing; 10 min setting; 15 min hitting & approach; 10 min serving (both float and topspin — the topspin gate must be observed live); 15 min defense / reading; 15 min 4-2 / 6-2 small-sided.
...
**Common biases to avoid.** (a) Maturity-blindness — pre-PHV athletes look weaker on power criteria but may have better coordination; weight the technique criteria, not the velocity. (b) Returning-athlete halo — score what you see today, not last season. (c) Setter-vacancy bias — do not promote a non-setter into the setter lane just because the team needs one. (d) Standing-topspin clemency — the gate is the gate; an athlete who cannot execute the topspin from cue is 13s-track for another season, regardless of how strong her float is. (e) Penalty-rep contamination — Munciana-style accountability drills create pressure organically; do not stack coach-imposed penalties on top.
