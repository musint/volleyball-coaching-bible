...
kind: club-ops
audience: coach
sources: [aoc-2025-cc-playing-time-roles, notes-gozansky-2001-coaching-volleyball-successfully]
---

# Club-Ops: Parent Communication Templates
...
>
> Questions about logistics only: reply to this email. Questions about evaluation criteria or selection: those will not be answered before notifications.
>
> {{coach-name}}
...
> Hi {{parent}} and {{athlete}},
>
> Thank you for trying out for {{age-group}}. We are not able to offer {{athlete}} a roster spot for the {{season}} season. Selection across {{N}} candidates for {{M}} spots was very close, and many capable players did not receive offers.
>
> If {{athlete}} would like brief written feedback on what to develop before next year, reply to this email and we will send a short note within two weeks. We do not discuss other athletes' evaluations or rank-orderings.
>
> Other clubs in the area still holding tryouts: {{list}}.
>
> {{coach-name}}
...
> Hi families,
>
> Welcome to {{season}}. A few reminders before practice {{N}}:
>
> - Practice schedule attached. Tournament calendar attached.
> - Communication: logistics through {{tool}}; coach-parent conversations by appointment, not before/after practice.
> - Playing-time and roles: addressed in scheduled meetings, not match-day texts. See the season handbook section on this.
> - SafeSport: all coaches are certified; report concerns to {{director}}.
>
> {{coach-name}}
...
> Hi families,
>
> {{tournament}} is this {{day}}. Pool play starts {{time}}; arrival call is {{call-time}} at {{venue}}.
>
> Uniform: {{primary}} jersey first match, alternate as needed. Bring both. Hair tied back, no jewelry.
>
> Food/hydration: pack lunch + snacks; venue concessions are slow. {{athlete}} should eat 90 minutes before pool play.
>
> Spectator area: {{location}}. Please do not coach from the stands. We need the bench voice to reach players.
>
> {{coach-name}}
...
> Hi {{parent}},
>
> Quick update on {{athlete}} at the season midpoint. Strengths I'm seeing: {{1-2 specific}}. Development focus for the back half: {{1-2 specific}}.
>
> If you would like to schedule a 20-minute call to discuss, reply with two windows and I will confirm.
>
> {{coach-name}}
...
> Hi {{parent}},
>
> {{athlete}} sustained a {{description}} during {{practice/match}} on {{date}} at approximately {{time}}. {{athletic-trainer}} evaluated on-site at {{time}} and recommended {{recommendation}}. {{athlete}} {{is/is-not}} cleared for the next session pending {{condition}}.
>
> Please confirm follow-up with your physician and reply with return-to-play documentation before next practice. CC: {{director}}, {{athletic-trainer}}.
>
> {{coach-name}}
...
> Hi {{parent}},
>
> I will not discuss playing time over text or in the 24 hours after a match. I am happy to schedule a 20-minute call to discuss {{athlete}}'s development and current role. Please reply with two windows next week and I will confirm one.
>
> Two ground rules for the call: we discuss only {{athlete}}, not other athletes; and the call is about development and role clarity, not about renegotiating match-day decisions.
>
> {{coach-name}}
...
- [[notes-gozansky-2001-coaching-volleyball-successfully]]
