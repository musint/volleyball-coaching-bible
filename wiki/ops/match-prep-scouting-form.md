...
kind: match-prep
audience: coach
sources: [aoc-2017-rose-pennstate-prep, aoc-2024-kiraly-stats-matter-most, aoc-2024-rose-best-servers, aoc-2018-rose-bad-servers, aoc-2024-kiraly-in-game-tactics]
---

# Match-Prep Scouting Form
...
Fill the form from one or more of:

- One pool-play match watched live, with notes (the club-tournament reality)
...
**Opponent:** ___________________ **Date scouted:** ___________________ **Scout source(s):** ___________________

### Player profiles

| Position | # / Name | Handedness | Key tendencies | Errors-under-pressure |
|---|---|---|---|---|
| Setter | | R / L | Tempo prefs (1st-tempo target, back-set frequency, dump/push freq); OOS habits (where she sets when off the net) | Forced-set tendency, pressure dump or pressure shoot |
| OH1 | | R / L | Best zones (line / cross / cut / high-hands); blocked-against tendencies; preferred set height | What breaks under big-point pressure (line→cross? swing→tip?) |
| OH2 | | R / L | Best zones; blocked-against tendencies; pin-vs-pipe split | |
| MB1 | | R / L | Slide vs. 31 frequency (% of attempts); blocking range (does she travel? closes well?); read-block vs. commit tendency | |
| MB2 | | R / L | Slide vs. 31 frequency; blocking range; commit habits | |
| Opp | | R / L | Range (back-row pipe / D / bic comfort); second-tempo comfort; line vs. cross split | Big-point shot tendency |
| Libero | | R / L | Defensive zones (deep-5? short-1? perimeter-vs-rotation cheat?); dig-to-set tendencies (when is she the second contact?); serve-receive primary zone | |
...
| Tendencies under pressure | Timeouts called when? Substitution patterns? Servers they trust at deuce / set point? |

### One-line plan

**Where we score:** _________________________________________________ (rotations, server-target combos)
**Where we get scored on:** __________________________________________ (their strong rotations, our risk hitter)
**One thing the bench watches all match:** ____________________________
