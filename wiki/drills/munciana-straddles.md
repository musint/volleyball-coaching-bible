...
video-url:
variations: [munciana-three-man-tilt, munciana-speed-close]
---

# Straddles

## Setup
Passer on the court. Tosser across with a ball. Target at setter position. Mike calls the drill: "let's go straddles. One down. One up" **[00:02:08]**.
...
- Pair with [[munciana-three-man-tilt]] before, [[munciana-speed-close]] after.

## Adaptations by level
- **14U:** slow tosses; have the passer say "left" or "right" before each pass to lock in the shoulder cue.
- **HS / college:** tighter cadence; coach grades each tilt as a 0-3 pass.
