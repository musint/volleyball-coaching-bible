---
type: drill
name: Front-Back Sets
primary-skill: setting
secondary-skills: [communication]
techniques: [setting-hands, setting-backset]
phase: skill
team-size-min: 3
team-size-max: 6
duration-min: 10
...
equipment: [ball-cart]
sources: [aoc-2024-setting-fundamentals, aoc-2024-setting-hand-hinge]
variations: [three-setter-rotation, target-setting]
---
...
One setter at a target zone centered on the net (setter position, Zone 2/3 boundary). One hitter at the left-front pin (Zone 4), one hitter at the right-front pin (Zone 2). Coach at the mid-court tossing position with a ball cart. Players rotate through the setter slot every 10 contacts or every 60 seconds, whichever comes first. A hoop or cone on each pin marks the target landing zone.
...
- **14U:** Verbal cues only; coach-tossed passes; lower net expectations; hitters catch rather than attack. Introduce after stationary hand-setting is reliable.
- **HS:** Random calls, live pass from a passer rather than coach toss, live attack on half the reps.
- **College:** Full attack tempo with a live block; setter graded on disguise frame-by-frame via film.
