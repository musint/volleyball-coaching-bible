---
type: drill
name: Cooperative 25 Goal
primary-skill: passing
secondary-skills: [setting, hitting]
techniques: [passing-forearm, setting-hands, hitting-approach]
phase: competition
team-size-min: 6
team-size-max: 6
duration-min: 12
...
sources: [aoc-2024-kiraly-50-percent-drill, aoc-2023-kiraly-competing-in-practice]
video-url:
variations: [wash-drill, gold-medal-scrimmage]
---

# Cooperative 25 Goal

## Setup
One team of 6 on the court. Coach enters balls from the opposite side of the net at mid-court with a ball cart. Running counter visible to the team. "In-system" defined by the coach ahead of time: for example, pass must reach a 2 m zone at the setter, set must be hittable at the pin, attack must clear the net and land in bounds.
...
- **14U:** target 15 in a row, attacks can be roll shots.
- **HS:** target 25 in a row, standard rules.
- **College:** target 25 with coach hitting hard; dig must arrive at the setter for the rep to count.
