---
type: drill
name: Munciana Full Corner Pepper
primary-skill: defense
secondary-skills: [hitting, setting, transition]
techniques: [defense-platform, defense-pursuit, hitting-shot-selection, setting-hands]
phase: skill
team-size-min: 5
team-size-max: 5
duration-min: 6
...
video-url:
variations: [munciana-nine-man-pepper, neville-pepper, pepper]
---

# Munciana Full Corner Pepper

## Setup
One defender in **each of the four court corners** plus a setter in the middle of the court. Coach starts the drill by tossing a ball over to one side. **[00:49:50]** "Full corner of pepper is not an easy drill. It's another cooperative drill. We don't want the ball to hit the floor."
...
- **HS**: 60 seconds without error; tossed entry.
- **College**: 90 seconds without error; live swings; pace as fast as the setter can deliver.
