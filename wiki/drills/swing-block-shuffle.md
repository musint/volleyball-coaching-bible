---
type: drill
name: Swing Block Shuffle
primary-skill: blocking
secondary-skills: []
techniques: [blocking-swing, blocking-footwork]
phase: skill
team-size-min: 3
team-size-max: 6
duration-min: 10
levels: [hs, college]
equipment: [cones, ball-cart]
sources: [aoc-2024-slabe-blocking]
video-url:
variations: []
---
...
## Setup
One blocker starts in a ready stance at mid-net. Coach opposite with a
ball cart. Three cones mark attack points: each pin antenna plus a seam
six feet inside each pin. Line of blockers waits; rotate every three reps.

## Execution
The teaching is when to swing-block vs. shuffle: swing when the travel is
...
Plant the outside foot last on the pin so hips rotate back square.

## Variations
Run as a two-blocker close: middle swing-blocks while pin shuffle-closes
to meet. Add a setter feed so the read comes off live hands.
