...
techniques: [passing-forearm, setting-hands, hitting-approach, defense-platform]
phase: competition
team-size-min: 6
team-size-max: 24
duration-min: 20
...
sources: [aoc-2023-kiraly-competing-in-practice, aoc-2019-nine-reasons-teams-fail]
video-url:
variations: [king-of-the-court, gold-medal-scrimmage]
---
...
## Variations
- **2-on-2:** beach-like, every player owns every touch.
- **4-on-4:** adds a setter and a middle; rally length jumps.
- **Serve entries:** challenger serves instead of coach free-ball.

## Adaptations by level
- **14U:** teams of 3 with free-ball entries; accept any clean attack for termination.
- **HS:** teams of 3 with live-serve entries.
- **College:** teams of 4 with live serves and required attacking zones.
