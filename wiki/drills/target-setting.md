...
secondary-skills: []
techniques: [setting-hands]
phase: skill
team-size-min: 2
team-size-max: 6
duration-min: 8
levels: [14u, hs, college]
equipment: [hoop, ball-cart, cones]
sources: [aoc-2024-setting-hand-hinge]
variations: [front-back-sets, jump-setting-progression]
---
...
A hoop suspended from the antenna at setter-target height, or a large bucket on a mid-court stand at the Zone 4 pin. Setter at the net in standard setter position. Coach at mid-court with a ball cart. Shaggers behind the target catching missed balls. Two setters alternate so one is always ready to go; total group 2-6 players.
...
- Add a second target at Zone 2 for back-sets; alternate front and back on call.
- Move the target off the antenna by 2-3 feet to train setters who consistently set too tight.
- Shrink the target hoop as make rate climbs.

## Adaptations by level

- **14U:** Large bucket or wide hoop; coach-tossed passes only; good-pass reps only for the first month, then introduce seam and overthrow.
- **HS:** Standard hoop; live passer on the overthrow shape.
- **College:** Shrunken target; live serve-receive as the pass shape; track make rate by shape in a log.
