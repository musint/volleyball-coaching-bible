...
video-url:
variations: [six-player-defense, emergency-pursuit]
---
...
## Variations
- **Zone-specific:** coach attacks only one zone to drill positional reads.
- **Combo tip/hit:** mix tips and hard-driven balls so the defender must read intent.
- **Scored streak:** team must string together 6 perfect digs (target-reachable) before a miss resets.

## Adaptations by level
- **14U:** coach tosses or down-balls from the 3-meter line; prioritize platform shape over speed.
- **HS:** coach attacks live off a box; add movement before the dig.
- **College:** attacks from multiple zones, mix in off-speed shots, target accuracy required inside a 2 m window.
