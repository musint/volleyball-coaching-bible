---
type: drill
name: Triangle Passing Off a Box B
primary-skill: passing
secondary-skills: [setting, hitting, communication]
techniques: [passing-forearm, passing-serve-receive, setting-hands]
phase: skill
team-size-min: 8
team-size-max: 14
duration-min: 8
...
video-url:
variations: [munciana-seam-to-attack]
---

# Triangle Passing Off a Box B

## Setup
Triangle of three passers in the back court. Setter at the net target. Box hitter on a stand at the middle position hitting B-tempo balls. Live or coached attack from the box. Mike: "now we go from tossed balls to live balls. This drill can be changed however you want it. You can go with live hitters. You can go with box hitters. You can go with no hitters" **[00:07:56]**.
...
- **14U:** down-ball or controlled box hits; 15 quality passes target.
- **HS:** live box B at game pace; 25 quality passes.
- **College:** live attacker, no easy resets, full setter-scoring rigor.
