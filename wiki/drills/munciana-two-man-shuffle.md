---
type: drill
name: Two-Man Shuffle
primary-skill: passing
secondary-skills: [defense]
techniques: [defense-pursuit, passing-forearm]
phase: warm-up
team-size-min: 6
team-size-max: 24
duration-min: 3
...
- **HS / college:** longer shuffle, add a defensive reaction (hit the floor on a coach call) before the recovery.
