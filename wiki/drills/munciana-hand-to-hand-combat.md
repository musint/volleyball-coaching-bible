---
type: drill
name: Munciana Hand-to-Hand Combat
primary-skill: defense
secondary-skills: [setting, transition]
techniques: [defense-reading, setting-hands, defense-platform]
phase: competition
team-size-min: 12
team-size-max: 12
duration-min: 6
...
video-url:
variations: [munciana-net-six, six-player-defense]
---

# Munciana Hand-to-Hand Combat

## Setup
Full 6v6 on a regulation court. Mike's frame: **[00:58:55]** "This is a drill to focus on using your hands on defense."
...
- 14U: catch instead of hand-dig as a teaching shortcut.
- Add a serve entry.

## Adaptations by level
- **14U**: not appropriate as written; hand digging at 14U is risky and ref-illegal at younger ages. Use overhand passing in [[munciana-tight-triangles]] as a substitute.
- **HS**: standard rules; play to 7.
- **College**: standard rules; play to 10; live serves.
