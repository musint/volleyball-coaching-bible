...
equipment: [balls, ball-cart, cones]
sources: [munciana-2022-camp-drills]
video-url:
variations: [munciana-five-before-ten, zone-serving]
---
...
1. Servers serve one ball at a time. Live ball lands in one of four zones, each with its own consequence:
   - **Gut (middle of court)**: 1 push-up. **[00:29:44]** "If they serve a ball in the middle of the court, they got to go back and give me one push-up."
   - **Out of bounds (long or wide)**: 5 push-ups.
   - **In the net**: 10 push-ups. "Now we have zero chance of scoring."
   - **Anywhere else (in front of or to the side of the dots, in-bounds)**: nothing.
2. Servers shag their own bad serve before paying the consequence.
3. Drill runs the standard 5-minute serving block.
