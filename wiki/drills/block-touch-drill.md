---
type: drill
name: Block Touch Drill
primary-skill: blocking
secondary-skills: [defense]
techniques: [blocking-hand-position, blocking-read]
phase: skill
team-size-min: 3
team-size-max: 6
duration-min: 8
levels: [hs, college]
equipment: [ball-cart]
sources: [aoc-2015-mccutcheon-blocking-keys]
video-url:
variations: []
---
...
(touches / 15). Back-row picks up every deflection and plays it to a
coach catch; the dig reinforces that the block is the front of the
defense, not an end in itself.

1. Round 1: predictable zones, medium pace.
2. Round 2: any zone at the pin, full pace.
3. Round 3: hard-driven mixed with off-speed roll; hands commit every rep.

Target 60%+ touch rate at HS, 75%+ at college.

## Coaching points
Hands over the net, not reaching up. Every clean ball through is a
...
## Variations
Add a second attacker at the opposite pin; middle closes and the pair
rebuilds the block every rep. Track kill rate against block + defense
