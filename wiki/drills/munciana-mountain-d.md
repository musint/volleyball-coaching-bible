...
video-url:
variations: [munciana-campfire-d, munciana-speedball]
---

# Mountain D

## Setup
Defenders line up on the court in a mountain-climber position (hands and feet on the floor, hips low). Coach stands with a ball and feeds plays. Mike's framing: "Mountain D is a drill you will see. It's really about teaching your kids start low, stay low, play low" **[00:17:39]**.
...
- **14U:** catch-to-exit only; large camp setting; no hit-over rule.
- **HS:** add the hit-over rule for HS-fit groups.
- **College:** hit-over to a target zone for the rep to count.
