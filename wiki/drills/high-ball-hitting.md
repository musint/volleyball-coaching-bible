...
techniques: [hitting-approach, hitting-arm-swing, hitting-shot-selection]
phase: skill
team-size-min: 3
team-size-max: 6
duration-min: 10
...
video-url:
variations: [approach-and-swing, line-vs-angle-shot, hitting-vs-block]
---
...
2. Hitter completes the full approach and attacks into the open court or past the soft block.
3. Hitter shags, returns to the line.
4. 8-12 swings per hitter; rotate sides.
...
- **14U:** coach tosses; focus on high contact and keeping the ball in; no block.
- **HS:** live setter; add the soft box-block as a visual obstacle.
- **College:** live setter from a dig-to-set sequence; live 1-blocker; shot-quality scoring.
