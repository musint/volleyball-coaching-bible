...
techniques: [hitting-approach, blocking-footwork]
phase: warm-up
team-size-min: 6
team-size-max: 12
duration-min: 8
...
equipment: []
sources: [aoc-2021-teach-spiking]
video-url:
variations: [dynamic-warmup-volleyball, reactive-jumping]
---
...
## Variations
- **Block-mirror closer.** Add 3 mirrored [[blocking-footwork]] reps finishing with a vertical.
- **Reactive add-on.** Extend into [[reactive-jumping]] when the session calls for reaction-primed jumping.
- **Approach-and-swing roll-in.** Transition into [[approach-and-swing]] once the warmup closes.

## Adaptations by level
- **14U:** skip tuck jumps early-season; substitute squat jumps. Cap approach reps at 3 each.
- **HS:** full sequence; cap session-total jumps per staff guidance.
- **College:** individualized prehab programmed by S&C; team warmup shorter.
