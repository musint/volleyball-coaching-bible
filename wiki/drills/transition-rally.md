---
type: drill
name: Transition Rally
primary-skill: transition
secondary-skills: [defense, hitting]
techniques: [transition-attack, defense-platform, hitting-approach]
phase: strategic
team-size-min: 12
team-size-max: 12
duration-min: 15
...
sources: [aoc-2024-kiraly-validation-6v6, aoc-2023-kiraly-competing-in-practice]
video-url:
variations: [wash-drill, six-player-defense]
---

# Transition Rally

## Setup
Full 6v6 on a regulation court. Coach with a ball cart at the sideline near the endline of Team A. Scorer tracks two running tallies: "points earned" and "transition points earned." Only transition points count toward the game total.
...
- **Rotate with each point:** losing team rotates one position, exposing every lineup to transition reps.

## Adaptations by level
- **14U:** free balls only; accept any successful transition attack regardless of quality.
- **HS:** mix free balls and coach-hit down balls.
- **College:** coach attacks off a box to simulate live opponent; 15 transition points to win.
