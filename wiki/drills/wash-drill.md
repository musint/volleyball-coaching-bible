...
techniques: [transition-attack, defense-platform, hitting-shot-selection]
phase: competition
team-size-min: 12
team-size-max: 12
duration-min: 20
...
sources: [aoc-2022-rose-coach-for-life, aoc-2023-kiraly-competing-in-practice]
video-url:
variations: [transition-rally, gold-medal-scrimmage]
---

# Wash Drill

## Setup
Full 6v6 on a regulation court. Coach with a ball cart at the sideline. Whiteboard or clip-chart visible to both teams to track "rally wins" and "washes." Rule: a team must win two consecutive rallies to score one real point. A split (win one, lose the next) "washes" both rallies and the count resets.
...
- **14U:** two-rally wash with free-ball entries only; shorter target score (6 banked points).
- **HS:** standard wash to 10.
- **College:** three-in-a-row wash to 15 with live serves.
