---
type: drill
name: Three-Way Release
primary-skill: defense
secondary-skills: [transition]
techniques: [defense-pursuit, defense-platform, defense-reading]
phase: skill
team-size-min: 6
team-size-max: 12
duration-min: 10
...
video-url:
variations: [munciana-figure-eight-defense, munciana-seat-to-seam]
---

# Three-Way Release

## Setup
Defenders break out of the right and left back-court positions. Coach with a cart at the attack line. Mike's framing: "one of the problems our teams have or people have is their guys don't know how to move on the court. So the more movement we can do, the better we are" **[00:13:30]**.
...
- Live phase up-the-line first, then through-the-middle, on the same group.
- Pair with [[munciana-figure-eight-defense]] to layer chase mechanics on top of release mechanics.

## Adaptations by level
- **14U:** stay in no-ball phases longer; only one live phase per session.
- **HS:** all three phases each side; live ball thrown, not hit.
- **College:** live attack from a box, both sides, with a transition swing after the dig.
