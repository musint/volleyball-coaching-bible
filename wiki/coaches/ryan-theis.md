...
tags: [marquette, aoc-contributor, team-drill-designer]
sources:
  - aoc-2021-theis-square-cooperative-drill
  - aoc-2023-theis-setter-vision-work
...
**Head coach (Marquette University [unsourced]).** The ingested AOC source base identifies Theis as a Division I head coach; the specific institution and tenure are inferred but not preserved in each piece's metadata [aoc-2021-theis-square-cooperative-drill] [aoc-2023-theis-setter-vision-work] [unsourced].

**AOC contributor (2021-present).** Theis publishes in AOC's Premium Content tier across team-drill, setter-vision, and scoring-design categories [aoc-2021-theis-square-cooperative-drill] [aoc-2023-theis-setter-vision-work] [aoc-2026-theis-earn-vs-give-points].
...
**Square cooperative-drill template.** The 2021 square-cooperative drill gives the AOC catalog a durable team-ball-control drill template that other head coaches have adopted as warm-up raw material [aoc-2021-theis-square-cooperative-drill].

**Earn-vs-give scoring taxonomy.** Theis's framing of points into earn vs. give categories is a portable drill-design mechanic that separates the teaching signal in competitive drills [aoc-2026-theis-earn-vs-give-points].

## Quotes & representative passages

[unsourced] Direct transcript-level quotations from Theis are not preserved in the AOC editorial prose on file; fetching AOC video captions for his drill segments would be the path to populate this section.
