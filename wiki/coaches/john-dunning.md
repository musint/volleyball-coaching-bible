...
country: USA
era: 1977-present
roles: [coach, university-of-pacific, stanford-cardinal, aoc-co-founder]
schools: [art-of-coaching-volleyball, usa-volleyball]
tags: [stanford-dynasty, pacific-dynasty, five-time-ncaa-champion, aoc-co-founder, avca-leadership]
sources:
  ...
  - aoc-2024-dunning-non-starter-side
...
makes someone you interact with doubt you care") and for a rigorously taught
system that he was nonetheless willing to tear down and rebuild mid-season when
personnel or circumstances demanded it [dunning-2016-aoc-difference-maker].

## Coaching career

Dunning's arc is an improbable one for a program-builder at his level: he
entered the sport in 1977 with no volleyball background, beginning at Fremont
High School in California, and famously slept in his car while attending a
[[terry-liskevych]] clinic in Stockton so he could afford to learn the game
[aoc-2017-liskevych-dunning-tribute]. He won state titles at Fremont and
founded the Bay Club to develop younger talent before his collegiate career
began [dunning-2016-aoc-difference-maker].

- **University of the Pacific (16 seasons).** Dunning took over the Pacific
  women's program and built it into a consistent national power, capturing two
  NCAA championships at Pacific as part of the five-title career total later
  summarized by Liskevych [aoc-2017-liskevych-dunning-tribute]. The Pacific
...
- **AOC and AVCA service (2011–present).** Dunning co-founded AOC in 2011
  ...
  and after his coaching career [aoc-2017-liskevych-dunning-tribute]. Since
  retirement he has remained a frequent AOC contributor, producing
  fundamentals articles on setting, serving, passing, and attacking
  [aoc-2024-setting-hand-hinge][aoc-2024-float-serve-toss][aoc-2020-passing-principles][aoc-2018-dunning-hitter-types].

## Core teaching principles

**Care is the foundation of credibility.** Dunning's most-quoted principle,
paraphrased by Stanford captain Inky Ajanaku, is "Never act in a way that
makes someone you interact with doubt you care"
[dunning-2016-aoc-difference-maker][aoc-2017-liskevych-dunning-tribute]. It is
the organizing principle of his program-management work. In his own "10
things I've learned" list he frames it as a non-negotiable: among listening,
hiring, and competing, the care principle sits third and colors all of them
[aoc-2017-dunning-10-things]. Stanford captains and AOC editorial both
identify this ethic as the reason players accepted hard coaching and mid-season
tactical pivots from him [aoc-2017-liskevych-dunning-tribute].

**System-centric but never system-rigid.** Dunning builds teaching systems
rigorously, then adjusts them when personnel or circumstances change
[dunning-2016-aoc-difference-maker]. The case-in-chief is the 2016 Stanford
run: injuries forced a mid-season conversion from a 6-2 to a 5-1 and a
...
and the serving warm-up progression [aoc-2018-dunning-serve-warmup]. The
teaching persona is technical and specific, not exhortatory.

**Competitiveness as a cornerstone, not a byproduct.** "One of the cornerstones
of success is competing. Focus on it, practice it, recruit it. Find a way to
put it at the center and make it grow" [aoc-2017-dunning-10-things]. Dunning
treats competitiveness as a cultural input coaches design for, not a trait
that emerges on its own. He extends this principle to the non-starter side of
the net: Stanford ran drills where a non-starter who beat the starters earned
a switch-side rep with the starting lineup, pushing both sides and making
every practice rep matter [aoc-2024-dunning-non-starter-side]. He credits the
2016 championship partly to the non-starter side "bringing it in practice
every day" [aoc-2024-dunning-non-starter-side].
...
team pick a song and sing together, a lighthearted accountability routine that
reinforced the gym's atmosphere without escalating the stakes
[aoc-2017-dunning-makes-players-sing].

**Match preparation preserves character.** Dunning's pre-match posture is
explicit: "Be the most relaxed team in the gym," and don't be the team that
can't compete at the end [aoc-2017-dunning-stanford-character]. His scouting
priority is the opponent's strength, not only their weakness, and Stanford's
...
[[russ-rose]] as one of the defining American collegiate head coaches of the
modern era.
...
profile reports roughly 31,000 followers and describes itself as the "top
resource for VB coaches" with USAV Academy endorsement. The AOC library
itself contains Dunning's own instructional articles on fundamentals
[aoc-2024-setting-hand-hinge][aoc-2024-float-serve-toss][aoc-2018-dunning-serve-warmup],
philosophy [aoc-2017-dunning-10-things][aoc-2018-dunning-team-culture], and
program management [aoc-2024-dunning-non-starter-side].
...
biggest leverage point; better tosses give players control of ball contact and
...
that style and target its gaps [aoc-2018-dunning-hitter-types].
...
rather than a single technique [aoc-2020-passing-principles]. The Chapel Hill
and Las Vegas clinics circulated his work on culture, chemistry, and match
preparation to working coaches through the late 2010s
[aoc-2018-dunning-team-culture][aoc-2017-dunning-stanford-character].
...
- "One of the cornerstones of success is competing. Focus on it, practice
  it, recruit it. Find a way to put it at the center and make it grow."
  [aoc-2017-dunning-10-things]
...
- On the 2016 title: "One of the reasons our team won at the end of the
  season was because the other side of the team brought it in practice
  every day. They believed in what they were doing and were excited by it."
  [aoc-2024-dunning-non-starter-side]

- On the float serve: "Tossing, I think, is the worst skill in volleyball."
  Better tosses let players "control the contact of the ball," producing
