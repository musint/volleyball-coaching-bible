...
tags: [simon-fraser, canada-youth-nt, former-national-team-player]
sources:
  - aoc-2024-attack-approach
  - aoc-2021-schmidt-setter-eyes-off-ball
  - aoc-2021-hofer-schmidt-overload-isolation
...
Gina Schmidt is a Canadian head coach and clinician whose AOC byline
spans attack approach, setter decision-making, serving mindset, reading,
and attacker-versus-block tactics. She is head women's coach at **Simon
Fraser University** and a **Canada Youth National Team** staff
contributor, and AOC material identifies her as a former Canadian
...
stance compatible with the [[art-of-coaching-volleyball]] pedagogy with a
tactically-specific setter and server voice
[aoc-2025-schmidt-setters-run-offense] [aoc-2026-training-reading].

## Coaching career

Schmidt's AOC output begins in the early 2020s. Her 2021 setter-vision
video is one of her earliest byline appearances, introducing her as a
former Canadian NT athlete now coaching setters
[aoc-2021-schmidt-setter-eyes-off-ball]. The same spring-2021 cluster
includes a co-bylined overload-vs-isolation video with Trinity Western's
Ryan Hofer, where both are framed as "elite college coaches" working the
Canadian U Sports circuit [aoc-2021-hofer-schmidt-overload-isolation]. By
2024 AOC identifies her as Simon Fraser's head coach
...
reading-training piece with Ben Josephson [aoc-2026-training-reading].

## Core teaching principles

**Approach tempo is slow-to-fast, not a single-speed sprint.** Schmidt's
attack-approach framework is three cues stacked: start slow and
accelerate during the last two steps; exaggerate arm swing during the
approach to add jump height; the hitter should always be at the same
spot in her approach when the ball leaves the setter's hands
[aoc-2024-attack-approach]. The slow-fast cadence is the tempo anchor on
[[hitting-approach]] stage-4 ("slow-slow, fast-fast") and the 14U
...
weakest blocker [aoc-2021-hofer-schmidt-overload-isolation]. Concrete
middle-blocker read: gap open on a 31 → set the middle; middle fronting
→ back-set the isolated right side [aoc-2025-schmidt-setters-run-offense].
Setter vision is trainable: she teaches setters to momentarily look away
from the ball pre-contact via a number-call drill (coach flashes a
number; setter glances and calls it) for 10-20 reps
[aoc-2021-schmidt-setter-eyes-off-ball].
...
minority of servers can credibly execute zone-specific targets and that
tough-serve-anywhere usually outperforms easy-to-zone
[aoc-2025-schmidt-serving-mindset].
...
look-see-decide diagnostic [aoc-2026-training-reading]. Applied to
...
Fraser / Canada Youth NT role bridges the Canadian college track and the
federation development pipeline, a lineage also running through
MacDonald at Volleyball Canada
[aoc-2024-macdonald-advanced-attacking-block].

## Quotes & representative passages

On setter transparency: "It's OK to talk with your whole team about why
the setter is doing what they're doing. (The team needs to) understand
that if this is the matchup and it keeps working, keep doing it. If it
...
hitter should always be at the same spot in their approach"
[aoc-2024-attack-approach].
