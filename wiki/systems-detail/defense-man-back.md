...
- LF and MF block.
- RF pulls off the net to cover short cross and tips immediately behind the block.
- LB plays at the 10-foot line in zone 5, covering the line.
- MB (the "man-back") plays deep zone 6, right on the end line, covering deep cross and the long tool.
- RB plays at or near the 10-foot line in zone 1, covering the short line or the high cross that comes over the block.

In a libero-forward variant, the libero plays man-back and the two wings move up. In a "red" variant, both wings move up to the 10-foot line and the man-back is alone in the deep third.

## Strengths
- Role clarity. Every defender knows exactly what they own. Communication burden is the lowest of any team defense because there is no rotation to coordinate.
- Strong against hard-hitting teams. A deep committed defender is where the hardest balls go; giving one player the whole deep zone often produces more digs than spreading two over the same area.
- Teachable fast. Man-back installs in one practice and sticks; at 14U, this matters as much as any tactical consideration [aoc-2026-team-defense-reading].
- Pairs cleanly with a pressing block, since the back defender's presence lets the block commit to penetration without worrying about the long ball [aoc-2017-liskevych-asics-defense].
...
Use man-back when:
- You face a hard-hitting opponent whose primary attack lands deep.
- Your roster has one clear back-court standout (libero or experienced DS) who can be the anchor.
- Teaching time is limited and you need a durable scheme with minimal coordination demands.
